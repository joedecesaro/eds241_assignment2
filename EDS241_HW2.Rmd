...
ci$fit
```
The predicted Dnox_masstons in a county that was not regulated under NBP and where PctBlack is above the sample median is `r ci$fit[1, 1]`. We are 95% confident that the true predicted value for a county that was not regulated under NBP and where PctBlack is above the sample median is between `r ci$fit[1, 2]` and `r ci$fit[1, 3]`.
